...
from mssg import MultiSenseSkipGram
...
def process(args):
  ...
  if data_size < args.max_memory_data_size:
    ...
    model = MultiSenseSkipGram(walks, size=args.representation_size, window=args.window_size, min_count=0, workers=args.workers)
